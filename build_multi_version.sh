...
# ==============================================================================
# MULTI-VERSION MACOS COMPATIBILITY BUILD SCRIPT
# Based on build.sh with multi-version macOS support
# ==============================================================================
...
echo "Building People.ai Screensaver for multi-version macOS compatibility..."
...
SAVER_PATH="$ARCHIVE_PATH/Products/Users/happy/Library/Screen Savers/$SCHEME_NAME.saver"
